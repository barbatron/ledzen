...
export const createRgbChannels = (
  brightness,
  settings = ColorCycleChannelSettings
) => {
  const createChannel = (setting) =>
    new Channel({
      position: setting.position,
      factor: setting.factor * brightness,
      color: setting.barColor,
      compensation: setting.compensation,
    });
